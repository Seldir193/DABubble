...
export class ChatComponent implements OnInit {
  ...
  async openThreadChannelFromSearch(result: any): Promise<void> {
    // Vorher hattes du hier sehr viel Code (~50 Zeilen).
    // Jetzt rufen wir stattdessen kleinere, klar benannte Methoden auf:
