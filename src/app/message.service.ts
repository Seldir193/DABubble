...
export class MessageService {
  ...
  /**
   * getChannelMessagesOnce fetches a one-time list of all messages that have a
   * non-null channelId (indicating they're normal channel messages) from Firestore,
...
public async setUserOnlineStatus(userId: string, isOnline: boolean): Promise<void> {
